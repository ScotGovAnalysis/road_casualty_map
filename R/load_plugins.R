...
cluster_plugin_dir <- normalizePath(file.path(system.file(package = "leaflet"),
                                              "htmlwidgets",
                                              "plugins",
...
clusterPlugin <- htmlDependency("leafletCluster.plugins", "1.4.1",
                                ...
                                stylesheet = c("MarkerCluster.Default.css", 
                                               "MarkerCluster.css"))

# same with awesome icons plugin
awesome_plugin_dir <- normalizePath(file.path(system.file(package = "leaflet"),
                                              "htmlwidgets",              
                                              "plugins",
...
awesomePlugin <- htmlDependency("Leaflet.awesome-markers", "2.0.3",
                                ...
                                script = c("leaflet.awesome-markers.js",
...
subgroupPlugin <- htmlDependency("leafletSubGroup.plugins", "1.0.2",
                                 src = normalizePath(here("javascript", 
                                                          "plugins")),
